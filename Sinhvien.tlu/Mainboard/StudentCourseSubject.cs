...
{
    public class StudentCourseSubject_CourseSubject
    {
        public string code { get; set; }
        public string shortCode { get; set; }
        public List<StudentCourseSubject_Timetable> timetables { get; set; }
        ...
        public StudentCourseSubject_Teacher teacher { get; set; }
        public StudentCourseSubject_SemesterSubject semesterSubject { get; set; }
    ...
    public class StudentCourseSubject_EndHour
    {
        public int id { get; set; }
    ...
    public class StudentCourseSubject_Room
    {
        public int id { get; set; }
        public string name { get; set; }
        public string code { get; set; }
    ...
    public class StudentCourseSubject_Root
    {
        public int id { get; set; }
        ...
        public int numberOfCredit { get; set; }
        public StudentCourseSubject_CourseSubject courseSubject { get; set; }
    ...
    public class StudentCourseSubject_Semester
    {
        public int id { get; set; }
    ...
    public class StudentCourseSubject_SemesterSubject
    {
        public int id { get; set; }
        public object semesterName { get; set; }
        public object subjectName { get; set; }
        public StudentCourseSubject_Subject subject { get; set; }
        public StudentCourseSubject_Semester semester { get; set; }
    }

    public class StudentCourseSubject_StartHour
    {
        public int id { get; set; }
        public string name { get; set; }
        public object start { get; set; }
    ...
    public class StudentCourseSubject_Subject
    {
        public int id { get; set; }
        public string subjectCode { get; set; }
        public string subjectName { get; set; }
    ...
    public class StudentCourseSubject_Teacher
    {
    ...
    public class StudentCourseSubject_Timetable
    {
        public int id { get; set; }
        public StudentCourseSubject_EndHour endHour { get; set; }
        public StudentCourseSubject_StartHour startHour { get; set; }
        public StudentCourseSubject_Teacher teacher { get; set; }
        public object assistantTeacher { get; set; }
        public StudentCourseSubject_Room room { get; set; }
